...
function exec(_code, compatibility) {
  let code = _code;
  let sandbox = {
...
function line(type, code, compatibility, moreOut = {}, compareStats = undefined) {
...
function dump(name, raw, min = raw, compatibility = "browser", outputFilename) {
  console.log(chalk.inverse(name));
  let beforeStats = line("Before", min, compatibility);

  let start = Date.now();
  let realm = (0, _construct_realm2.default)({ serialize: true, compatibility });
